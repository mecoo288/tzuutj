  ...
  <div>  
    <div class="ui dropdown item">
      ...
      <div class="ui menu" id="myregionone">
        <a  v-for="city in citys_limit" class="item" @click="selectme"  :data-code="city.code">{{city.name}}</a>
      </div>
  ...
  export default{
   ...
   data(){
    return {
      ...
      citys_limit: $store.state.default.citys_limit
    }
  },
  props: ['firstType'],
  mounted(){
