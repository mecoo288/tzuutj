...
const  download=(state,payload)=>{
  var data = payload.toData;
  /*[['asdfasdfasdfasd', 'sdadfasdf', 'ddd', "sheetjs"],["foo","bar",new Date("2014-02-19T14:30Z"), "0.3"], [4, 1,2,3]]*/
...
const filterLogin = (state,payload)=>{
...
const resetSearchPage=(state,payload)=>{
